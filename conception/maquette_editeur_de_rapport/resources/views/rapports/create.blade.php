...
<div class="content-header">
    <div class="container-fluid">
        ...
        <div class="row mb-1">
          <div class="col-md-2">
            <input type="text" class="form-control" name="rapport_title" placeholder="Nom de présentation" style="height: 36px;">
          </div>
          <!-- /.col -->
        </div>
...
<div class="row mx-2">
    ...
    <div class="markdown_div col-md-12">
      ...
      <textarea name="rapport_markdown" id="markdown"></textarea>
  </div>
...
<div class="col-md-3 ml-2 mb-5">
  <button class="btn btn-block bg-gradient-warning"><i class="fa-solid fa-floppy-disk"></i> Enregistrer</button>
</div>
